...
<?php if ( get_header_image() != '' ) { ?> 
  <div class="header-image">
    <img class="header-img" style="width:100%;height:350px;" src="<?php header_image(); ?>" alt="<?php bloginfo( 'name' ); ?>" />
    <div class="header-image-container">
    <div class="header-image-text-wrapper">
      <div class="header-image-text">
<?php if ( $restimpo_options_db['restimpo_header_image_headline'] != '' ) { ?>
        <div class="header-image-headline"><p><?php echo esc_attr($restimpo_options_db['restimpo_header_image_headline']); ?></p></div>
<?php } if ( $restimpo_options_db['restimpo_header_image_text'] != '' ) { ?>
        <div class="header-image-info"><p><?php echo esc_attr($restimpo_options_db['restimpo_header_image_text']); ?></p></div>
