<div class="wrap">
	<h1><?php _e("Completed Courses", 'watupro');?></h1>
	...
	<table class="widefat">
		<tr><th><?php printf(__('%s title', 'watupro'), __('Courses'))?></th><th><?php _e('Completed on', 'watupro')?></th><th><?php _e('With result', 'watupro')?></th>
