...
function consulting_login_url($redirect = '', $force_reauth = false) {
...
function wp_registration_url() {
	 ...
	 */
	return apply_filters( 'register_url', site_url( 'registration', 'login' ) );
}
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	$lostpassword_url = add_query_arg( $args, network_site_url('forgot-password', 'login') );
